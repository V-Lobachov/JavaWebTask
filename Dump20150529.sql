...
CREATE TABLE `credit_card` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `credit_card_ibfk_2` FOREIGN KEY (`account_id`) REFERENCES `bank_account` (`id`),
...
INSERT INTO `credit_card` VALUES (1,'1234342374847436',1,1),(3,'1234567890123456',2,1),(4,'4321234563256546',3,3);
...
-- Dump completed on 2015-05-29 22:48:30
